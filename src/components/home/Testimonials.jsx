...
const testimonials = [
  {
    ...
    rating: 5,
    date: '3 weeks ago',
    text: 'Dr M k sinha has experience to diagnose any human disease properly & he is such surgeon who can operate any difficult problem',
    initials: 'AS',
    verified: true,
  },
  {
    ...
    rating: 5,
    date: '4 months ago',
    text: 'Had a great experience with Dr MK Sinha, The docs and staff were super professional and made me feel at ease. Facilities were clean and modern too. Highly recommend!',
    initials: 'AP',
    verified: true,
  },
  {
    ...
    rating: 5,
    date: '5 months ago',
    text: "That's great to hear! It's always reassuring to find a good doctor, especially for specialized care like urology. If you're comfortable, you might consider leaving a review or referral for Dr. M K singha to help others in Patna find quality medical care.",
    initials: 'SK',
    verified: true,
  },
]
